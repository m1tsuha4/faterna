          ...
          <div class="col-lg-12">
            ...
            <article class="blog-details">
              ...
              <div class="post-img d-flex justify-content-center">
                <img width="800" src="{{ asset('storage/berita/'.$pengumuman->file) }}" alt="" class="img-fluid">
              </div>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $pengumuman->author }} Faterna</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href=""><time datetime="2020-01-01">
                      {{ $pengumuman->tanggal }}</time></a></li>
                </ul>
              </div><!-- End meta top -->
