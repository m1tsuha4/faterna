            ...
            @foreach($kiprah as $k)
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('storage/berita/'.$k->file) }}" alt="" class="img-fluid">
                        </div>

                        <p class="post-category">Kiprah Civitas Akademika</p>

                        <h2 class="title">
                            <a href="{{ route('detailkiprah',['id' => $k->id]) }}">{{ $k->judul }}</a>
                        </h2>

                        <div class="d-flex align-items-center">

                            <div class="post-meta">
                                <p class="post-author">{{ $k->author }} Faterna</p>
                                <p class="post-date">
                                    <time datetime="2022-01-01">{{ $k->tanggal }}</time>
                                </p>
                            </div>
                        </div>
