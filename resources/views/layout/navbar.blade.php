...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><img src="{{asset('assets/img/fti-logo.png')}}" alt=""></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Download</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{ route('dokumen') }}">SK Akreditasi Prodi S1</a></li>
              <li><a href="{{ route('dokumen') }}">SK Akreditasi Prodi S2</a></li>
              <li><a href="{{ route('dokumen') }}">SK Akreditasi Prodi S3</a></li>
              <li><a href="{{ route('dokumen') }}">SK Review Karya Ilmiah</a></li>
              <li><a href="{{ route('dokumen') }}">Surat Bebas Labor</a></li>
              <li><a href="{{ route('dokumen') }}">Form Penyelesaian Tugas Akhir</a></li>
            </ul>
          </li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Address</h3>
            <p>
              Kampus Unand Limau Manis, Padang - Fakultas Teknologi Informasi Unand<br>
              <strong>Sumatera Barat:</strong> - 25163<br>
              <strong>Phone:</strong> +62 853-5610-5388<br>
