        ...
        <div class="row gy-8 mt-5 justify-content-center">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="{{ route('sejarah-prodi-pdg') }}" class="stretched-link">Sejarah</a></h4>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="{{ route('visi-misi-prodi-pdg') }}" class="stretched-link">Visi-Misi</a></h4>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="{{ route('tujuan-prodi-pdg') }}" class="stretched-link">Tujuan</a></h4>
            </div>
          </div><!--End Icon Box -->
